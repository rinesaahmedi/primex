             ...
             <div className="relative group">
               ...
               <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-slate-200 bg-white">
                 ...
                 <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-md px-4 py-2 rounded-lg shadow-sm border border-slate-100 flex items-center gap-2">
                    ...
                    <span className="text-xs font-mono font-semibold text-slate-700">SYSTEMS ACTIVE</span>
                 </div>
               </div>
             </div>
          </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {pillars.map((pillar, index) => {
              ...
              const palettes = [
                { bg: "from-[#e4edff] to-[#f1f5ff]", color: "#2378FF", border: "border-blue-100" },
                { bg: "from-[#fce8ff] to-[#fff3ff]", color: "#CDABFF", border: "border-purple-100" },
                { bg: "from-[#fff1dc] to-[#fff8ec]", color: "#F2A436", border: "border-orange-100" },
                { bg: "from-[#e0efff] to-[#f2f9ff]", color: "#2378FF", border: "border-blue-100" },
              ];
