...
const Agent11Page = () => {
  ...
  useEffect(() => {
    ...
    sectionKeys.forEach((key) => {
      const el = document.getElementById(`agent11-${key}`);
      if (!el) return;
  ...
  const visuals = {
    overview: {
      ...
      title: t("agents.agent11.visuals.overview.title"),
      description: t("agents.agent11.visuals.overview.description"),
      label: t("agents.agent11.visuals.label"),
    },
    capabilities: {
      image: agentCapabilitiesImg,
      title: t("agents.agent11.visuals.capabilities.title"),
      description: t("agents.agent11.visuals.capabilities.description"),
      label: t("agents.agent11.visuals.label"),
    },
    useCases: {
      image: agentUseCasesImg,
      title: t("agents.agent11.visuals.useCases.title"),
      description: t("agents.agent11.visuals.useCases.description"),
      label: t("agents.agent11.visuals.label"),
    },
    cta: {
      image: agentCtaImg,
      title: t("agents.agent11.visuals.cta.title"),
      description: t("agents.agent11.visuals.cta.description"),
      label: t("agents.agent11.visuals.label"),
    },
  };

  const currentVisual = visuals[activeVisual];
  const capabilities = t("agents.agent11.capabilities.items", {
    returnObjects: true,
  });
  const useCaseCards = t("agents.agent11.useCases.cards", {
    returnObjects: true,
  });
          ...
          <div>
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#2378FF]/10 text-[#2378FF] text-sm font-semibold mb-6">
                ...
                <span>{t("agents.agent11.badge")}</span>
              </div>
              <h1
                className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6"
                style={{ fontFamily: "var(--font-serif)" }}
              >
                {t("agents.agent11.title")}
              </h1>
              <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-3xl">
                {t("agents.agent11.subtitle")}
              </p>
            </div>
            ...
            >
              <div className="bg-gradient-to-br from-[#2378FF] to-[#1f5fcc] rounded-xl p-6 text-white shadow-lg">
                ...
                <div className="text-3xl font-bold mb-1">
                  {t("agents.agent11.metrics.processingTime.value")}
                </div>
                <div className="text-sm opacity-90">
                  {t("agents.agent11.metrics.processingTime.label")}
                </div>
              </div>
              <div className="bg-gradient-to-br from-[#CDABFF] to-[#b894ff] rounded-xl p-6 text-white shadow-lg">
                ...
                <div className="text-3xl font-bold mb-1">
                  {t("agents.agent11.metrics.efficiency.value")}
                </div>
                <div className="text-sm opacity-90">
                  {t("agents.agent11.metrics.efficiency.label")}
                </div>
              </div>
              <div className="bg-gradient-to-br from-[#FADEBC] to-[#f5d4a8] rounded-xl p-6 text-gray-900 shadow-lg">
                ...
                <div className="text-3xl font-bold mb-1">
                  {t("agents.agent11.metrics.accuracy.value")}
                </div>
                <div className="text-sm opacity-80">
                  {t("agents.agent11.metrics.accuracy.label")}
                </div>
              </div>
            </div>

            <div
              id="agent11-capabilities"
            ...
            >
              <h2
                ...
                style={{ fontFamily: "var(--font-serif)" }}
              >
                {t("agents.agent11.capabilities.title")}
              </h2>
            ...
            >
              <h2
                ...
                style={{ fontFamily: "var(--font-serif)" }}
              >
                {t("agents.agent11.useCases.title")}
              </h2>
            ...
            >
              <div className="bg-gradient-to-br from-[#081333] via-[#1659bd] to-[#fadebc] rounded-2xl p-8 md:p-12 text-white">
                <h3
                  ...
                  style={{ fontFamily: "var(--font-serif)" }}
                >
                  {t("agents.agent11.cta.title")}
                </h3>
                <p className="text-white/90 mb-8 text-lg">
                  {t("agents.agent11.cta.body")}
                </p>
                <div className="flex flex-wrap gap-4">
                  ...
                  >
                    {t("agents.agent11.cta.secondary")}
                  </Link>
                </div>
              </div>
            </div>
